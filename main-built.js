define('modules/header',['require'],function (require) {
  ...
  header.prototype = {
    ...
    render () {
      ...
      document.querySelector(this.$el).innerHTML = this.$html
    },
    $el: '',
    $html:/*html*/ `
...
;
define('modules/table',['require'],function (require) {
  ...
  table.prototype = {
    ...
    $el: '',
    $html: /*html*/ `<ul role="list" class="divide-y divide-gray-100">
...
// requirejs.config({
//   baseUrl: 'src/modules',
//   deps: ['app'], // 指定主模块加载前的依赖模块
//   callback: function () {
//     // 所有模块加载完成后的回调函数
//   }
// })
requirejs(['modules/header', 'modules/table'], (Header, Table) => {
